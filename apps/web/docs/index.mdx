---
title: Introduction
description: Generate media and text, and filter, rank, and select records from the terminal.
order: 1
---

ai-cli is an agent-native CLI for generating text, images, video, and audio, and evaluating records with composable commands. It uses the [Vercel AI SDK](https://sdk.vercel.ai) and [AI Gateway](https://vercel.com/docs/ai-gateway) for unified access to hundreds of models.
...
<Cards>
  ...
  <Card title="Semantic decisions" description="Filter by meaning, rank by a rubric, and pick an original record with Jev." href="/docs/decisions" />
...
<Cards>
  ...
  <Card title="filter / rank / pick" description="Evaluate records from stdin and return selected records." href="/docs/decisions" />
