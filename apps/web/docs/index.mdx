...
ai-cli brings the [Vercel AI SDK](https://sdk.vercel.ai) to your terminal with composable commands for text, images, video, audio, and evaluation. It uses [AI Gateway](https://vercel.com/docs/ai-gateway) for unified access to hundreds of models.
