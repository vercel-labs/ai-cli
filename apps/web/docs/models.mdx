...
| evaluation (filter/rank/pick) | `typesafe-ai/jev` | `AI_CLI_EVALUATION_MODEL` |
...
Decision commands accept exactly one evaluation model per invocation. They do not fall back to text generation models.
...
ai models --type evaluation        # evaluation models such as Jev
...
<Cards>
  ...
  <Card title="TypeSafe" description="Jev evaluation: filter, rank, and pick records" />
