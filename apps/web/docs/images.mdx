...
The original image format is preserved in the saved file. JPEG, WebP, and SVG
responses are converted to PNG automatically for the Kitty graphics preview.
SVG previews use a 512-pixel long edge and an opaque white background while the
saved SVG remains unchanged.
